        ...
        return (
            React.createElement("div", null, 
                React.createElement("table", {className: that.props.className}, 
                        ...
                        (function () {
                            return (
                                React.createElement(Actbody, {data: source, itemName: bItem})
                            );
                        })()
                    ...
                    (function () {
                        if(that.props.pagination && Pagination && typeof Pagination === 'function'){
                            return (
                                React.createElement(Pagination, {data: source, options: that.props.pagination})
                            );
                        }
                    })()
        ...
        return (
            React.createElement("div", {className: "text-right"}, 
                React.createElement("ul", {className: "pagination"}, 
                        ...
                        (function () {
                            return (
                                React.createElement("li", {className: "paginate_button"/*onClick={that.turnTo(i)}*/}, 
                                ...
                                if (i === 5) {
                                    ...
                                    return (
                                        React.createElement("li", {className: "paginate_button"}, 
                                            React.createElement("a", {href: "#"}, linkTotal)
                                        )
                                    );
                                }else{
                                    return (
